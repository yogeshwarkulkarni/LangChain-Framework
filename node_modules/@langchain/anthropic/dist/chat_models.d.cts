...
declare class ChatAnthropicMessages<CallOptions extends ChatAnthropicCallOptions = ChatAnthropicCallOptions> extends BaseChatModel<CallOptions, AIMessageChunk> implements AnthropicInput {
  ...
  /** @ignore */
  _generateNonStreaming(messages: BaseMessage[], params: Omit<Anthropic$1.Messages.MessageCreateParamsNonStreaming | Anthropic$1.Messages.MessageCreateParamsStreaming, "messages"> & Kwargs, requestOptions: AnthropicRequestOptions, cacheControl?: {
    type: "ephemeral";
    ttl?: "5m" | "1h";
  }): Promise<{
