 ...
 */
declare function computer_20251124(options: Computer20251124Options): DynamicStructuredTool<zod51.ZodDiscriminatedUnion<[zod51.ZodObject<{
  action: zod51.ZodLiteral<"screenshot">;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"left_click">;
  coordinate: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber], null>;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"right_click">;
  coordinate: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber], null>;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"middle_click">;
  coordinate: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber], null>;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"double_click">;
  coordinate: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber], null>;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"triple_click">;
  coordinate: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber], null>;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"left_click_drag">;
  start_coordinate: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber], null>;
  end_coordinate: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber], null>;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"left_mouse_down">;
  coordinate: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber], null>;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"left_mouse_up">;
  coordinate: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber], null>;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"scroll">;
  coordinate: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber], null>;
  scroll_direction: zod51.ZodEnum<{
    down: "down";
    left: "left";
    right: "right";
    up: "up";
  }>;
  scroll_amount: zod51.ZodNumber;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"type">;
  text: zod51.ZodString;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"key">;
  key: zod51.ZodString;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"mouse_move">;
  coordinate: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber], null>;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"hold_key">;
  key: zod51.ZodString;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"wait">;
  duration: zod51.ZodOptional<zod51.ZodNumber>;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"zoom">;
  region: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber, zod51.ZodNumber, zod51.ZodNumber], null>;
}, zod_v4_core11.$strip>], "action">, Computer20251124Action, any, ToolMessage<any>, string>;
/**
 ...
 * @returns The computer use tool object that can be passed to `bindTools`
 */
declare function computer_20250124(options: Computer20250124Options): DynamicStructuredTool<zod51.ZodDiscriminatedUnion<[zod51.ZodObject<{
  action: zod51.ZodLiteral<"screenshot">;
}, zod_v4_core11.$strip>, zod51.ZodObject<{
  action: zod51.ZodLiteral<"left_click">;
  coordinate: zod51.ZodTuple<[zod51.ZodNumber, zod51.ZodNumber], null>;
  ...
  action: zod51.ZodLiteral<"wait">;
  duration: zod51.ZodOptional<zod51.ZodNumber>;
}, zod_v4_core11.$strip>], "action">, Computer20250124Action, any, ComputerUseReturnType, string>;
//#endregion
